    ...
    <el-container>
        ...
        <el-mian class="main">
            <el-tabs tab-position="left">
                ...
                <el-tab-pane label="工作交流"></el-tab-pane>
                <el-tab-pane label="知识教育"></el-tab-pane>
                <el-tab-pane label="技能培训"></el-tab-pane>
            </el-tabs>
        </el-mian>
    </el-container>
</div>
