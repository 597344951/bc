...
public class HttpUtil {
    ...
    public static Result postFile(String url, String formName, InputStream inputStream, String fileName) {
        ...
        try {
            ...
            String disposition = "Content-Disposition: form-data; " + "name=\"" + formName + "\";filename=\"" + fileName + "\"" + lineBreak;
            dataOutputStream.write(disposition.getBytes("utf-8"));
            dataOutputStream.writeBytes("Content-Type: " + FileContentTypeUtil.getContentType(fileName) + lineBreak);
