...
public class ReportTypeController extends BaseController {
    ...
    @RequiresPermissions("report:type:save")
    ...
    @RequiresPermissions("report:type:update")
    ...
    @RequiresPermissions("report:type:delete")
