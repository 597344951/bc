...
public class MaterialAlbumTest extends BaseTests {


    /**生成 查询Where 代码**/
    @Test
    public void testWhereCode() throws Exception {
        StringBuilder sb = MyBatisScriptCreateUtil.createWhereScript(MaterialAlbum.class);
        logout.info(TemplateType.class.getName() +" _> WHERE: \n"+sb.toString());
        
        sb = MyBatisScriptCreateUtil.createSelectScript(MaterialAlbum.class);
