...
public class ResourceMaterialTest extends BaseTests {


    /**生成 查询Where 代码**/
    @Test
    public void testWhereCode() throws Exception {
        StringBuilder sb = MyBatisScriptCreateUtil.createWhereScript(ResourceMaterial.class);
        logout.info(TemplateType.class.getName() +" _> WHERE: \n"+sb.toString());
        
        sb = MyBatisScriptCreateUtil.createSelectScript(ResourceMaterial.class);
